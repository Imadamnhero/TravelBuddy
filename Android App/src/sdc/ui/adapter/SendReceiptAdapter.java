...
public class SendReceiptAdapter extends BaseAdapter {
	...
	private SendReceiptFragment mCallBack;

	public SendReceiptAdapter(Context c, List<Photo> data,
			SendReceiptFragment callback) {
		mContext = c;
		mData = data;
		mCallBack = callback;
